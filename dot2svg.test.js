...
Deno.test("round", () => {
  t.assertEquals(dot2svg([[1, 1, 1], [1, 0, 1], [0, 1, 0]], 10, 1), `<path d="M1,0 L29,0 Q30,0 30,1 L30,19 Q30,20 29,20 L21,20 Q20,20 20,19 L20,11 Q20,10 19,10 L11,10 Q10,10 10,11 L10,19 Q10,20 9,20 L1,20 Q0,20 0,19 L0,1 Q0,0 1,0"/>
<path d="M11,20 L19,20 Q20,20 20,21 L20,29 Q20,30 19,30 L11,30 Q10,30 10,29 L10,21 Q10,20 11,20"/>`)
});
Deno.test("round2", () => {
  t.assertEquals(dot2svg("111\n101\n111", 10, 1), `<path d="M1,0 L29,0 Q30,0 30,1 L30,29 Q30,30 29,30 L1,30 Q0,30 0,29 L0,1 Q0,0 1,0 M10,11 L10,19 Q10,20 11,20 L19,20 Q20,20 20,19 L20,11 Q20,10 19,10 L11,10 Q10,10 10,11"/>`)
});
...
1000001
1111111
  `, 10, 1), `<path d="M1,0 L69,0 Q70,0 70,1 L70,69 Q70,70 69,70 L1,70 Q0,70 0,69 L0,1 Q0,0 1,0 M21,20 L49,20 Q50,20 50,21 L50,49 Q50,50 49,50 L21,50 Q20,50 20,49 L20,21 Q20,20 21,20 M30,31 L30,39 Q30,40 31,40 L39,40 Q40,40 40,39 L40,31 Q40,30 39,30 L31,30 Q30,30 30,31 M10,11 L10,59 Q10,60 11,60 L59,60 Q60,60 60,59 L60,11 Q60,10 59,10 L11,10 Q10,10 10,11"/>`)
});
